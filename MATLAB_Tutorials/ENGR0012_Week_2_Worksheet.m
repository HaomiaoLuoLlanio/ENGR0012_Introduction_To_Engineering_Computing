...
%%
%[text] The same if you define z `= 8.7` in the ***Command Window*** and add a semicolon
...
%[text] To be consistent, let's not create a row vector using both commas and spaces to delimit, although there is no error to do so.
...
%%
%[text] Note that it is separated by semicolons ;
...
%%
%[text] How to check whether C really has **2 rows and 3 columns**, instead of 3 rows and 2 columns
% check C's dimension here

%%
%[text] A matrix cannot have mismatched dimensions on different rows, e.g., 1 2 3 4; 7 8 9; 10 11 12 13
...
%%
% What if we want to sum all the elements together?
...
%%
% sort: sort elements in a vector 10 2 3 4 from largest to smallest
...
%%
% A = 5.145, B = [4, 6; 9, 12], use disp() to display to screen instead of ;
...
%%
% Access the element in the 1st row, 1st column of the 5x2 matrix ones

%%
% Modify individual elements in an array
% Set the element in the 2nd row, 3rd column of the '5x2 matrix ones' to 10

%%
% Show the new matrix

%%
% Set the element in the 6th row, 1st column of the '5x2 matrix ones' to 5
